...
const int main_ls_val = 150;
const int rnsr_ls_val = 100;
const int wipr_lft_val = 32;
const int wipr_rgt_val = 30;
const int cyt_stop_val = 33;
...
const int wipr_open_ang = 44;

const double ultrasonic = -44.0;
const double rinser = 16.5;
const double wiper = 23.5;
